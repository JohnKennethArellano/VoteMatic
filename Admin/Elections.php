...
<div class="menu" id="menu">
    ...
    <div class="active">
        <div class="activeTitle">Active Election</div>
        <div class="activeList" id="activeList">

        </div>
    </div>   
    <div class="ended">
        <div class="endedTitle">Past Elections</div>
        <div class="endedList" id="endedList">
        </div>
    </div> 
    </div>
    </div>
...
$(document).ready(function(){
    $.get("activeElection.php", function(data){
        $("#activeList").html(data);
    })
    $.get("endedElection.php", function(data){
        $("#endedList").html(data);
    })
