...
if(isset($_POST['addPosition'])){
        ...
        if(mysqli_num_rows($res) > 0){
            ...
            if($diff < 0){
                ...
                $sql = "INSERT INTO `position`(`positionID`, `ElectionID`, `Description`, `Max_Vote`, `Priority`, `status`,`WinnersCount`) VALUES ('',".$_SESSION['eID'].",'$posName','$maxVote','$priority','active','$winCount')";
