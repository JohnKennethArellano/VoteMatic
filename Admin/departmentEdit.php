...
if(isset($_POST['editDep'])){
        ...
        $depName = mysqli_real_escape_string($conn,$_POST['depNameEdit']);
        $depName  = ucfirst($depName);
        ...
        if(mysqli_num_rows($res) > 0){
            ...
            if($diff < 0){
              ...
              $sql = "UPDATE `department` SET `DepartmentName`='$depName' where ID = ".$_SESSION['editDept'].";";
