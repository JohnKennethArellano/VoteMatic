...
if(isset($_POST['editPartylist'])){


        $partName = mysqli_real_escape_string($conn,$_POST['partNameEdit']);
        ...
        if(mysqli_num_rows($res) > 0){
            ...
            if($diff < 0){
              ...
              $sql = "UPDATE `partylist` SET `partylistname`='$partName' where ID = ".$_SESSION['editPart'].";";
