...
if(isset($_POST['result'])){
    ...
    $sql1 = "SELECT * from position WHERE ElectionID = ".$_POST['result']." ORDER BY Priority;";
    ...
    if(mysqli_num_rows($result) > 0 ){
        while($row1 = mysqli_fetch_assoc($result1)){
            ...
            FROM voted
            WHERE ElectionID = ".$_SESSION['eID']." and pos_id = ".$row1['positionID']."
        ...
        echo '    <div class="exit">
        <button type="button" class="c2">Cancel</button>
        </div>';
    }
